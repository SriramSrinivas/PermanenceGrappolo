...
TARGET_13= driverForGraphPermanence
TARGET_14= driverForGraphOverlappingClustering
...
TARGET   = $(TARGET_4) $(TARGET_6) $(TARGET_7) $(TARGET_13) $(TARGET_14)
...
$(TARGET_13): $(IOOBJECTS) $(COOBJECTS) $(UTOBJECTS) $(FSOBJECTS) $(CLOBJECTS) $(TARGET_13).o
	$(CPP) $(LDFLAGS) -o ./$(TARGET_13) $(TARGET_13).o $(FSOBJECTS) $(IOOBJECTS) $(COOBJECTS) $(UTOBJECTS) $(CLOBJECTS) $(LIBS)
.c.o:
	$(CC) $(CFLAGS) -c $< -I$(INCLUDES) -o $@

$(TARGET_14): $(IOOBJECTS) $(COOBJECTS) $(UTOBJECTS) $(FSOBJECTS) $(CLOBJECTS) $(TARGET_14).o
	$(CPP) $(LDFLAGS) -o ./$(TARGET_14) $(TARGET_14).o $(FSOBJECTS) $(IOOBJECTS) $(COOBJECTS) $(UTOBJECTS) $(CLOBJECTS) $(LIBS)
.c.o:
	$(CC) $(CFLAGS) -c $< -I$(INCLUDES) -o $@
...
clean:
	rm -f *.o $(TARGET_1).o $(TARGET_2).o $(TARGET_3).o $(FSFOLDER)/*.o $(IOFOLDER)/*.o $(COFOLDER)/*.o
